<%-- 
    Document   : bill
    Created on : Apr 10, 2020, 2:22:13 PM
    Author     : Moazam
--%>
...
<div  id="exampl">
      ...
      <table border="1" class="table table-bordered mg-b-0">
        <tr>
            <th colspan="5" style="text-align: center; font-size:25px;"> Vehicle Parking receipt</th>
  ...
  PreparedStatement stmt=con.prepareStatement("select * from booking where bid=? ");
  stmt.setInt(1, i);
  ...
  while(rs.next())
   ...
   <tr>
       ...
       <td><%=rs.getString("bdate")%></td>
        ...
        <th>Status</th>
       <td><font color="green"><b>PAID</b></font></td>
       <th>Out time</th>
...
<%
  ...
  catch(Exception e)
  {
      e.printStackTrace();
             ...
             <br><br>
             <center>
             <form action="validatebill.jsp">
                 <input type="submit" value="<%=glo%>" name="billid" class="btn btn-success"><br>PAY
             </form>
             </center>
