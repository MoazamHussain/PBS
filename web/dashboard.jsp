<%-- 
    Document   : dashboard
    Created on : Apr 10, 2020, 2:24:01 PM
    Author     : Moazam
--%>
...
<header id="header" class="header">
  ...
  PreparedStatement stmt=con.prepareStatement("select count(*) as tb from booking where bdate=CURDATE() and amt='UNPAID'");  
  PreparedStatement stmt1=con.prepareStatement("SELECT count(*) as yb FROM booking WHERE amt='UNPAID' AND bdate BETWEEN CURDATE() - INTERVAL 1 DAY AND CURDATE() - INTERVAL 1 SECOND");
  PreparedStatement stmt2=con.prepareStatement("select count(*) as totb from booking where amt='UNPAID'"); 
                                ...
                                <div class="stat-widget-five">
                                    ...
                                    <div class="stat-content">
                                        <div class="text-left dib">
                                            <div class="stat-text"><span class="count"><%=todays%></span></div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="stat-widget-five">
                                    ...
                                    <div class="stat-content">
                                        <div class="text-left dib">
                                            <div class="stat-text"><span><%=yest%></span></div>
